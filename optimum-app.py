...
# "count" for current governance period.
...
# store "count" for which governance period in the fee account's local state
LOCAL_GOVERNANCE_NONCE: TealType.uint64 = Bytes("gov_nonce")

# constants
ACCOUNT_MIN_BALANCE = Int(1000000) # Setting min balance of app account as 1 ALGO
TEN_BILLION = Int(10000000000 * 1000000)
                ...
                InnerTxnBuilder.SetFields(
                    {
                        ...
                        TxnField.receiver: Global.current_application_address(),
                        TxnField.amount: Int(0),
                        # give control back to that account 
...
if __name__ == "__main__":
    ...
    print(compileTeal(approval_program(params["ARG_OPT_ASSET_INDEX"], params["ARG_FEE_ADDRESS"]), Mode.Application, version = 6))
